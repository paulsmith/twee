...
// CursorStyle is the visual shape requested by DECSCUSR.
...
// InputModes are the terminal modes that affect bytes generated by the host
// terminal for the wrapped child. Other child display modes remain model-only.
